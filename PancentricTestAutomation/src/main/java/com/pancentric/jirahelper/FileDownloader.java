...
public class FileDownloader {
    ...
    public static String fileDownloaderNonBrowser(String urlHREF, String downloadPath, Integer timeout) throws Exception {
    ...
    private static String fileWriter(String downloadPath, HttpResponse myResponse) {
    	...
    	try {
    		...
    		String fileName = getFileName(myResponse);
                ...
                File myFile = new File(downloadPath + fileName);
